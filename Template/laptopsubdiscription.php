...
<?php
    ...
    foreach ($sub_laptop->getData() as $sub) :
...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="<?php echo $sub['sub_image']  ?>" alt="product" class="img-fluid">
            ...
            <div class="col-sm-6 py-5">
                <h5 class="font-baloo font-size-20"><?php echo $sub['sub_name'] ?? "Unknown"; ?></h5>
                <small>by <?php echo $sub['sub_brand'] ?? "Brand"; ?></small>
                <div class="d-flex">
                ...
                <table class="my-3">
                    ...
                    <tr class="font-rale font-size-14">
                        <td>Deal Price:</td>
                        <td class="font-size-20 text-danger">₹<span><?php echo $sub['sub_price'] ?? 0; ?></span><small class="text-dark font-size-12">&nbsp;&nbsp;Inclusive of all taxes</small></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>You Save:</td>
