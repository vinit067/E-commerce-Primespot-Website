    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 py-5">
                ...
                <div class="size my-3">
                    <h6 class="font-baloo">Size :</h6>
                     <p class="font-rale font-size-14"> <td class="font-size-20 text-danger"><span><button><?php echo $item['item_size'] ?? 0; ?></button></span>
            ...
            <div class="col-12">
                ...
                <hr>
                <p class="font-rale font-size-14"> <td class="font-size-20 text-danger"><span><?php echo $item['item_description'] ?? 0; ?></span>
            </div>
        </div>
    </div>
</section>
